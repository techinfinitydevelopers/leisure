...
// Footer sound control: the decorative speaker ripple is now a live mute toggle.
// Ripple rings animate while sound is on; a slash + muted icon show when off.
export default function SoundToggle() {
  ...
  return (
    ...
    >
      {/* Ripple rings — only animate when sound is playing */}
      {!muted &&
        [0, 0.8, 1.6].map((delay) => (
          <span
            key={delay}
