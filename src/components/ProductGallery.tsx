...
export default function ProductGallery({ slug, model, colors }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* ── Main image ── */}
      <div className="relative isolate overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#141414] via-[#0d0d0d] to-[#000] gold-glow"
      ...
      <div className="flex gap-2 overflow-x-auto pb-1" style={{ scrollbarWidth: "none" }}>
        {images.map((src, i) => (
          <button
            ...
            style={{
              borderColor: i === activeImgIdx ? "#fbed2b" : "rgba(255,255,255,0.12)",
              background: "#0d0d0d",
            }}
      ...
      <div className="flex flex-wrap items-center gap-3 pt-1">
        ...
        {colors.map((color, i) => (
          ...
          >
            <span
              className="block h-8 w-8 rounded-full ring-2 ring-offset-2 ring-offset-black transition-all duration-200"
              style={{
                backgroundColor: color.hex,
                ringColor: i === activeColorIdx ? "#fbed2b" : "transparent",
